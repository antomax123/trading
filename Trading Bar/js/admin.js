...
setInterval(function(){
	...
	// son début.
	if(avant_soiree){
		let minutes_avant_debut = Math.round((debut_soiree - Date.now())/1000/60/60)
		...
		// affiche le temps avant le prochain recalcul des prix.
		...
		// execute toutes les fonctions pour le recalcul des prix.
		if(secondes_avant_refresh == 0){
			...
			// boucle pour avoir la première clé du dictionnaire.
			for(let boisson in boissons){
